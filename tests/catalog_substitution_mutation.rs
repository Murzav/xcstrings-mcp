...
const SOURCE: &str = r#"{"sourceLanguage":"en","strings":{"birds":{"localizations":{"en":{"stringUnit":{"state":"translated","value":"%#@BIRDS@"},"substitutions":{"BIRDS":{"argNum":1,"futureSub":9,"formatSpecifier":"lld","variations":{"plural":{"one":{"stringUnit":{"state":"translated","value":"%arg bird"}},"other":{"stringUnit":{"state":"translated","futureUnit":true,"value":"%arg birds"}}}}}}}}}},"version":"1.0"}"#;
